package com.xyoye.sardine.impl;

import android.text.TextUtils;

import com.xyoye.sardine.DavAce;
import com.xyoye.sardine.DavAcl;
import com.xyoye.sardine.DavPrincipal;
import com.xyoye.sardine.DavQuota;
import com.xyoye.sardine.DavResource;
import com.xyoye.sardine.Sardine;
import com.xyoye.sardine.impl.handler.ExistsResponseHandler;
import com.xyoye.sardine.impl.handler.InputStreamResponseHandler;
import com.xyoye.sardine.impl.handler.LockResponseHandler;
import com.xyoye.sardine.impl.handler.MultiStatusResponseHandler;
import com.xyoye.sardine.impl.handler.ResourcesResponseHandler;
import com.xyoye.sardine.impl.handler.ResponseHandler;
import com.xyoye.sardine.impl.handler.VoidResponseHandler;
import com.xyoye.sardine.model.Ace;
import com.xyoye.sardine.model.Acl;
import com.xyoye.sardine.model.Allprop;
import com.xyoye.sardine.model.Exclusive;
import com.xyoye.sardine.model.Group;
import com.xyoye.sardine.model.Lockinfo;
import com.xyoye.sardine.model.Lockscope;
import com.xyoye.sardine.model.Locktype;
import com.xyoye.sardine.model.Multistatus;
import com.xyoye.sardine.model.Owner;
import com.xyoye.sardine.model.PrincipalCollectionSet;
import com.xyoye.sardine.model.Prop;
import com.xyoye.sardine.model.Propertyupdate;
import com.xyoye.sardine.model.Propfind;
import com.xyoye.sardine.model.Propstat;
import com.xyoye.sardine.model.QuotaAvailableBytes;
import com.xyoye.sardine.model.QuotaUsedBytes;
import com.xyoye.sardine.model.Remove;
import com.xyoye.sardine.model.SearchRequest;
import com.xyoye.sardine.model.Set;
import com.xyoye.sardine.model.Write;
import com.xyoye.sardine.report.SardineReport;
...
//        prop.setGetetag(objectFactory.createGetetag());
    ...
    public DavAcl getAcl(String url) throws IOException {
        ...
        Multistatus multistatus = this.execute(request, new MultiStatusResponseHandler());
        List<com.xyoye.sardine.model.Response> responses = multistatus.getResponse();
    ...
    public List<DavPrincipal> getPrincipals(String url) throws IOException {
        ...
        if (responses.isEmpty()) {
            ...
            for (com.xyoye.sardine.model.Response r : responses) {
